<script type="template" id="404">
    <section class="section section-header header-homepage is-aligned--centered is-inverted" style="border:10px solid white">
        <video class="video-header-homepage" muted autoplay loop data-delay="0" data-transition-type="zoomIn">
            <source src="/static/video/404/404.mp4" type="video/mp4">
        </video>
        <div class="row fill-parent is-aligned--middle is-unpadded header-content">
