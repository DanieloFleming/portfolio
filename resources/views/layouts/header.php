<div class="navigation">
	<div class="navigation-panel">
		...
		<ul class="nav-list">
			<li class="nav-listitem"><a data-href="/" class="nav-link">Home</a></li>
			<li class="nav-listitem"><a data-href="/cases" class="nav-link">Cases</a></li>
        ...
        <ul class="list list-navigation-contact list-social--menu">
            ...
            <li class="list-item" style="margin-top: 10px;">
				<a href="mailto:connect@danielo.nl">
