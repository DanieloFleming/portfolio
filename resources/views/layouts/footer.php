<footer class="section is-inverted" style="padding:40px 0 15px !important;">
   <div class="container is-unpadded">
       <div class="row is-unpadded">
           <!--<div class="column span-10-10">
               <img src="/static/img/sprites/logo-white-footer.png" />
               <p style="font-size: 12px">Danielo Fleming</p>
           </div>-->
